...
raw
Handwriting generator index · MD
---
layout: default
...
<img src="api_generated_compressed.svg" alt="Handwriting generated by the model and drawn by the AxiDraw plotter" style="max-width:100%; height:auto; border:1px solid #e6e6e6; border-radius:6px; padding:10px; background:#fff;">
## How it works
